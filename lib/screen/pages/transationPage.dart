...
class _TransationPageState extends State<TransationPage> {
  ...
  setState(() {
    ...
    transactions = allTransactions;  // assuming `allTransactions` contains all transactions without any filter.
    ...
    transactions = transactions.where((transaction) {
      ...
      if (filterType == "Jour") {
        ...
        return dateValidation.isAfter(weekAgo) && dateValidation.isBefore(now);
